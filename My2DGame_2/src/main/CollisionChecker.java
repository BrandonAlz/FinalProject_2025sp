...
public class CollisionChecker {
    ...
    public int checkEntity(Entity entity, Entity[] target) {
        ...
        for (int i = 0; i < target.length; i++){
            if(target[i] != null && target[i] != entity){ // THIS IS THE FIX BTW
                ...
                switch(entity.direction) {
                    case "up": entityNextArea.y -= entity.speed; break;
                    case "down": entityNextArea.y += entity.speed; break;
                    case "left": entityNextArea.x -= entity.speed; break;
                    case "right": entityNextArea.x += entity.speed; break;
                }
