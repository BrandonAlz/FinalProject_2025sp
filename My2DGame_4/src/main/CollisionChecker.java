    ...
    public int checkObject(Entity entity, boolean player) {
        ...
        for (int i = 0; i < gp.obj[1].length; i++) {
            if (gp.obj[gp.currentMap][i] != null) {
                ...
                gp.obj[gp.currentMap][i].solidArea.x = (gp.obj[gp.currentMap][i].x + gp.obj[gp.currentMap][i].solidArea.x) * gp.tileSize;
                gp.obj[gp.currentMap][i].solidArea.y = (gp.obj[gp.currentMap][i].y + gp.obj[gp.currentMap][i].solidArea.y) * gp.tileSize;
